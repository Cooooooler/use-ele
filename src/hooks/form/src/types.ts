...
export type BaseFormComponentType = Record<never, never> & string;
...
export type FormItemDependenciesCondition<T = boolean | PromiseLike<boolean>> =
  (value: Partial<Record<string, any>>, actions: FormActions) => T;
